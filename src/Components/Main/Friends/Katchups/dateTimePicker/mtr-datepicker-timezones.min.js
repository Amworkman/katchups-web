...
export function MtrDatepickerTimezones() {
    var a = [ {
    ...
    this.getTimezone = function(i) {
        var t;
        return a.forEach(function(e) {
            "number" == typeof i ? e.offset === i && (t = e) : "string" == typeof i && (1 < i.split("/").length ? void 0 !== e.utc && e.utc.forEach(function(a) {
                a === i && (t = e);
            }) : e.abbr === i && (t = e));
        }), t;
    };
